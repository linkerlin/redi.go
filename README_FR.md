...
Elle a passé les **tests d’interopérabilité bidirectionnelle Go ↔ Redisson 4.6.1 réel** (54 fonctions `TestJavaInterop_*`) et la régression bidirectionnelle Go ↔ redi.py (dont Multimap). Les usines `Client.Get*` couvrent actuellement **66 types de retour R\* uniques**. Voir [CONTRIBUTING.md](CONTRIBUTING.md) pour contribuer.
