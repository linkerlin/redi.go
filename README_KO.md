...
**Go ↔ 실제 Redisson 4.6.1 양방향 상호 운용 테스트**(36개 `TestJavaInterop_*`)와 Go ↔ redi.py 양방향 회귀(Multimap 포함)를 통과했습니다. `Client.Get*` 팩토리는 현재 **66종의 고유 R\* 반환 타입**을 커버합니다. 기여 방법은 [CONTRIBUTING.md](CONTRIBUTING.md)를 보세요.
